...
<img src="assets/fig/statbinhex1-1.png" title=" " alt=" " style="display: block; margin: auto;" />
...
<iframe width="1000" height="760" src="/Users/fpgcdi/Dropbox/school/berkeley/general/Rdataviz/clickme0.html" frameborder=0> </iframe>
...
// jsData 
function gvisDataMotionChartID10e201d8cac41 () {
...
data.addColumn('number','win.pct');
data.addColumn('number','points.avg');
data.addColumn('number','mov.avg');
data.addColumn('number','tourney.seed');
data.addRows(datajson);
return(data);
}
 
// jsDrawChart
function drawChartMotionChartID10e201d8cac41() {
var data = gvisDataMotionChartID10e201d8cac41();
var options = {};
options["width"] =    750;
options["height"] =    650;
options["state"] = "\n{\"xAxisOption\":\"2\",\"yAxisOption\":\"5\",\"colorOption\":\"3\",\"sizeOption\":\"4\",\"dimensions\":{\"iconDimensions\":[\"dim0\"]}}\n";
    ...
    document.getElementById('MotionChartID10e201d8cac41')
    );
...
callbacks.push(drawChartMotionChartID10e201d8cac41);
})();
function displayChartMotionChartID10e201d8cac41() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartMotionChartID10e201d8cac41"></script>
 
<!-- divChart -->
  
<div id="MotionChartID10e201d8cac41" 
...
[1] L. Wilkinson. _The Grammar of Graphics_. Springer-Verlag New
York, 2005. DOI: 10.1007/0-387-28695-0. <URL:
http://dx.doi.org/10.1007/0-387-28695-0>.

[2] H. Wickham. _ggplot2_. Springer Science + Business Media,
2009. DOI: 10.1007/978-0-387-98141-3. <URL:
http://dx.doi.org/10.1007/978-0-387-98141-3>.

[3] H. Wickham. "A Layered Grammar of Graphics". In: _Journal of
Computational and Graphical Statistics_ 19.1 (2010), pp. 3-28.
DOI: 10.1198/jcgs.2009.07098. <URL:
http://dx.doi.org/10.1198/jcgs.2009.07098>.

[4] H. Wickham. "Tidy Data". In: _Journal of Statistical Software_
59.10 (2014). <URL: http://www.jstatsoft.org/v59/i10>.
